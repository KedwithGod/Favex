          ...
          return Column(
            children: [
              ...
              Row(
                ...
                children: [
                  ...List.generate(model.cardCountryList.length, (index) {
                    return GestureDetector(
                      ...
                      child: GeneralContainer(
                        ...
                        borderRadius: 16,
                        allSide: 8,
                        borderColor: model.selectedCountryIndex == index
                        ...
                        child: S(
                          ...
                          child: Column(
                            children: [
                              SvgPngImage(
                                path: model.cardCountryList[index]['icon'],
                                height: index ==
                                        model.cardCountryList.length - 1
                                    ? 24
                                    : 36,
                                width: index ==
                                        model.cardCountryList.length - 1
                ...
                onTap: () {
                  GeneralBottomSheet.show(context,
                      content: CryptoSelectorBottomSheet(
                        cryptoList: model.giftCardList,
                        imagetype: ImageTypeEnum.svg,
                        selectText:
                            textBucket!.chooseGiftcard, // Title text
                        searchHint:
                            textBucket!.searchCard, // Search field hint
                        onSelect: (index) {
                  ...
                  child: Row(
                    ...
                    children: [
                      InterText(model.selectedGiftCardIndex == null
                          ...
                          : model.giftCardList[model.selectedGiftCardIndex!]
                              ['name']),
                      S(
                        h: 13,
                        w: 13,
                      ...
                      content: GeneralContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...List.generate(model.cardRangeList.length,
                                (index) {
                              return GestureDetector(
                                  onTap: () {
                                    model.setSelectedCardRangeIndex(index);
                                    context.pop();
                                  },
                                  child: GeneralContainer(
                                    width: 335,
                                    height: 50,
                                    allSide: 10,
                                    color: model.selectedCardRangeIndex ==
                                            index
                                        ? colorsBucket!.primaryLemon
              ...
              S(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...List.generate(model.cardReciptList.length, (index) {
                      return GestureDetector(
                        onTap: () {
                        ...
                        child: GeneralContainer(
                          ...
                          child: Row(
                            ...
                            children: [
                              GeneralIconDisplay(
                                  model.selectedCardRecieptIndex == index
              ...
              Row(
                ...
                children: [
                 ...List.generate(model.cardValueList.length, (index){
                  return   GestureDetector(
                    onTap: (){
                    ...
                    child: GeneralContainer(
                      allSide: 12,
                      borderColor: model.selectedCardValueIndex ==index? colorsBucket!.transparent:colorsBucket!.borderDisabled
                      
                      , color: model.selectedCardValueIndex ==index? colorsBucket!.primary :colorsBucket!.backgroundMid,
                      borderRadius: 8, 
                      child: InterText(model.cardValueList[index], textColor: model.selectedCardValueIndex ==index? colorsBucket!.white: colorsBucket!.subtitle, textFontSize: 12,),
                    ),
                  );
                 })
                ],
